...
<p align="center">
  <a href="https://github.com/longsui48/sampool/actions">
  ...
  <a href="https://github.com/longsui48/sampool/releases">
...
配置文件模板见 config/config.yaml 文件，可选项区域均可不填。完整配置选项请查看[配置文件说明](https://github.com/longsui48/sampool/wiki/%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)。
...
从这里下载预编译好的程序 [release](https://github.com/longsui48/sampool/releases)。
...
首先修改 config.yaml 中的必要配置信息。带有默认值的字段均可不填写。完整的配置选项见[配置文件说明](https://github.com/longsui48/sampool/wiki/%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)
...
如果需要部署到VPS，更多细节请[查看wiki](https://github.com/longsui48/sampool/wiki/%E9%83%A8%E7%BD%B2%E5%88%B0VPS-Step-by-Step)。
...
此项非必须。为了提高实际可用性，可选择增加一个本地服务器，检测远程proxypool节点在本地的可用性并提供配置，见[proxypoolCheck](https://github.com/longsui48/sampoolCheck)。
